# Genre Advanced Development Framework
...
## Primary sources
- [Genre Development Playbook](./genre-development-playbook.md)
- [Genre Design Pattern Catalog](./genre-design-pattern-catalog.md)
- [Genre Example Matrix](./genre-example-matrix.md)
...
## Decision impact
- Use this framework after the genre preset and development playbook, but before a feature brief becomes implementation work.
