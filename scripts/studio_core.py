...
TASK_DISCIPLINE_KEYWORDS: dict[str, tuple[str, ...]] = {
    ...
    "save": ("save", "checkpoint", "load", "profile", "migration", "cloud save"),
    "gameplay": (
        "combat",
        "enemy",
        "boss",
    ...
    "ui-ux": ("ui", "hud", "menu", "ux", "settings", "tutorial", "accessibility", "subtitle"),
...
def related_research_refs(disciplines: list[str], engine_slug: str | None = None) -> list[str]:
